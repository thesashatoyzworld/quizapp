// Статья урока «10-praktikum-upakovka» курса «Новый Уровень Контента».
// СГЕНЕРИРОВАНО: GSD-BRAND/scripts/kurs-to-ts.mjs 10 — руками не править,
// править исходник kurs/10-praktikum-upakovka.html и перегенерировать.

export const PRAKTIKUM_UPAKOVKA_10 = `<!doctype html>
<html lang="ru">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Три способа найти упаковку · Новый уровень контента</title>
<style>
/* ============================================================
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Практикум</div>
  <h1>Три способа найти упаковку</h1>
  <p class="dek">Тот самый практикум, который я обещал на пятом уровне. Берём один смысл и разбираем его тремя инструментами вживую.</p>
  <div class="taskline"><b>Задача:</b> Взять один свой смысл и собрать к нему три захода - по одному каждым инструментом.</div>
</div></header>
