...
<blockquote><p>[!note] Про техническую часть</p><p>В этом курсе мы разбираем смысловую сторону: что делать, почему это не идет и как выстроить процесс под себя.</p><p>Если вы хотите разбираться в технических составляющих - хуки, заголовки, призывы к действию, как читать аналитику, что люди сохраняют и почему пересылают - все это подробно разобрано в <strong>Формуле Вирусного Контента</strong>, доступ к которой у вас есть.</p></blockquote>
</section>
<section>
...
<p><code>[интерактив: чужой путь. что вы видите → что достроили → как было на самом деле]</code></p>
<p>У них не ровно</p>
...
<p><code>[интерактив: один и тот же путь, разное увеличение. дни / годы]</code></p>
