...
<p>Давайте разберемся в причинах. Я называю это долиной отчаяния</p>
<p>Вот так она выглядит. И так выглядит любое движение к любой цели, которую вы себе поставили - возьмите это на вооружение</p>
