...
import { SOZVON_2026_08_10 } from './2026-08-10';
...
export const SOZVONY: Sozvon[] = [
  {
    slug: '2026-08-10',
    title: "Продажа как свидание: вопросы вместо оффера в лоб",
    subtitle: "Разбор по кругу: почему предложение в первом сообщении убивает сделку, сколько вопросов задавать до того, как заговоришь о себе, и что писать тем, кто пропал",
    date: '2026-08-10',
    duration: "64 мин",
    tags: ["продажи", "переписка", "созвоны", "контент"],
    participants: ["Даша", "Азамат", "Марат", "Евгений"],
    kinescopeId: 'wKWMFu3Py5KE1cVNqQeqqg',
    html: SOZVON_2026_08_10,
  },
  {
    slug: '2026-08-03',
