...
<div class="wrap">
  ...
  <section id="kto">
    ...
    <p><b>Её запрос своими словами:</b> хочу качать аккаунт про машины, потому что про BMW снимать легко, а про эзотерику сложно. Первый месяц ролики залетали, теперь еле набирают 50 по 70 тысяч просмотров, и не пойму, в чём дело.</p>
