...
<p>А тем, кто работает с контентом профессионально, здесь даже сложнее</p>
<p>Есть такая вещь, как творческая мана. Мы ее отдаем клиентам</p>
<p>Психолог или фитнес-тренер поработал с клиентом и сел за свой контент - у него хотя бы задача меняется. А у нас она не меняется</p>
...
<p>Вот что Сева сам говорит про то, как это выглядело изнутри:</p>
...
<p>Держу это время под глобальные задачи, потому что только они вытаскивают из замкнутых циклов и двигают проект вперед</p>
...
<p>Мы этого просто не осознаем, пока время есть</p>
<p>Поэтому посчитайте свою неделю честно: сколько единиц контента вы делаете и сколько часов уходит на каждую</p>
<p>Даже если сожмете не до тридцати минут, а до часа - вы выигрываете десятки часов в месяц. И это часы вашей жизни, а не абстрактная эффективность</p>
