...
export default function GenerousResult({ onPaymentClick, userId, resultId, scores, userName, userPhoto }: ResultProps) {
    ...
    <div className="result-page">
      ...
      <ResultSection title="РЕШЕНИЕ СУЩЕСТВУЕТ">
        ...
        <p className="text-cyan mb-lg">
          Помог <strong className="accent-number">300+ экспертам</strong> перестать создавать студентов и начать привлекать клиентов.
        </p>
