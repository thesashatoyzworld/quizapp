// Шаги ветки «Поток Спроса».
// СГЕНЕРИРОВАНО: node GSD-BRAND/scripts/potok-steps.mjs — руками не править.
// Содержимое вырезано из статей курса «Новый Уровень Контента»: источник правды
// там, здесь только копия под ветку. Правишь урок — перегенерируй ветку.
//
// html пустой = шаг раздаётся файлами (см. index.ts), а не статьёй.

export interface PotokStep {
  key: string;
  title: string;
  /** одна строка: что внутри шага */
  note: string;
...
export const POTOK_STEPS: PotokStep[] = [
  {
    key: "metod",
    title: "Метод: десять заходов в твоей нише",
    note: "Программа сама листает ленту и приносит то, что уже собрало реакцию. Методичка, правила для нейронки и готовый промпт — файлами ниже.",
    group: "",
    html: ``,
  },
  {
...
<title>Что такое заход и почему его можно брать · Поток Спроса</title>
<style>
/* ============================================================
...
<header class="arthead"><div class="ahin">
  ...
  <h1>Что такое заход и почему его можно брать</h1>
  <p class="dek">Первые три секунды или первый слайд. Единственная часть упаковки, которую честно взять у другого автора.</p>
</div></header>

<main class="wrap">
<section>
<h2>Из чего собирается упаковка</h2>
...
<section>
<h2>Форма и упаковка - это не одно и то же</h2>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Как выбирать то, что сработает · Поток Спроса</title>
<style>
/* ============================================================
   НОВЫЙ УРОВЕНЬ КОНТЕНТА — статьи уровней.
   Системный стиль, как в algoritm-sistema.html: Times, колонка 620,
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Поток Спроса</div>
  <h1>Как выбирать то, что сработает</h1>
  <p class="dek">Чем заход, который реально выстрелил, отличается от поста, набравшего по подписчикам.</p>
</div></header>
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Поток Спроса</div>
  <h1>Ютуб</h1>
  <p class="dek">Единственная площадка с нормальным поиском по запросам. Шортсы, фильтр по популярности, заходы из первых секунд.</p>
</div></header>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Английский сегмент · Поток Спроса</title>
<style>
/* ============================================================
   НОВЫЙ УРОВЕНЬ КОНТЕНТА — статьи уровней.
   Системный стиль, как в algoritm-sistema.html: Times, колонка 620,
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Поток Спроса</div>
  <h1>Английский сегмент</h1>
  <p class="dek">95% форматов и смыслов приезжает оттуда. Смыслы и форматы разобраны на живых примерах с цифрами.</p>
</div></header>

<main class="wrap">
<section>
<h2>Английский сегмент</h2>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Нейронка · Поток Спроса</title>
<style>
/* ============================================================
   НОВЫЙ УРОВЕНЬ КОНТЕНТА — статьи уровней.
   Системный стиль, как в algoritm-sistema.html: Times, колонка 620,
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Поток Спроса</div>
  <h1>Нейронка</h1>
  <p class="dek">То, что руками заняло бы два-три часа, программа делает за 15-20 минут. Нужен компьютер.</p>
</div></header>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Чем наполнять заход · Поток Спроса</title>
<style>
/* ============================================================
   НОВЫЙ УРОВЕНЬ КОНТЕНТА — статьи уровней.
   Системный стиль, как в algoritm-sistema.html: Times, колонка 620,
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Поток Спроса</div>
  <h1>Чем наполнять заход</h1>
  <p class="dek">Заход чужой, контент твой. Смысл, пруф и что делать, если своих результатов ещё нет.</p>
</div></header>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Из одного смысла двенадцать единиц · Поток Спроса</title>
<style>
/* ============================================================
   НОВЫЙ УРОВЕНЬ КОНТЕНТА — статьи уровней.
   Системный стиль, как в algoritm-sistema.html: Times, колонка 620,
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Поток Спроса</div>
  <h1>Из одного смысла двенадцать единиц</h1>
  <p class="dek">Один рабочий заход даёт не один пост. Как разложить его на серию и проверять гипотезами.</p>
</div></header>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Не зашло: куда смотреть и что докручивать · Поток Спроса</title>
<style>
/* ============================================================
   НОВЫЙ УРОВЕНЬ КОНТЕНТА — статьи уровней.
   Системный стиль, как в algoritm-sistema.html: Times, колонка 620,
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Поток Спроса</div>
  <h1>Не зашло: куда смотреть и что докручивать</h1>
  <p class="dek">Метрики по порядку: где отвалились и что чинить именно там, а не переснимать всё.</p>
</div></header>
...
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Разборы на живых примерах · Поток Спроса</title>
<style>
/* ============================================================
   НОВЫЙ УРОВЕНЬ КОНТЕНТА — статьи уровней.
   Системный стиль, как в algoritm-sistema.html: Times, колонка 620,
...
<p>В уроке про общую формулу я разложил единицу на смысл, пруф и упаковку и пообещал показать, как я собираю её руками</p>
<p>Вот это оно</p>
<p>Мы берём три роли - фитнес-тренер, психолог, коуч по отношениям - и на каждой прогоняем свой инструмент поиска упаковки</p>
<p>Роли выдуманные, механика настоящая</p>
</section>
<section>
<h2>Смысла мало</h2>
<p>У любого эксперта есть смысл, который он хочет донести</p>
<p>И почти всегда этот смысл сам по себе никому не нужен</p>
<p>Не потому что он плохой</p>
<p>А потому что его уже говорят все</p>
<p class="punch">«Для того чтобы похудеть, нужно мало жрать»</p>
<p>Правда? Правда</p>
<p>Полезно? Полезно</p>
<p>Смотреть это будут? Нет</p>
<p>В соцсети человек заходит не учиться, а отвлечься</p>
<p>Поэтому работает только связка: вы берёте то, во что верите, и заворачиваете в оболочку, которую человеку интересно съесть</p>
<p>А вместе с оболочкой он проглатывает и ваш тезис</p>
<p>Дальше вопрос один - где эту оболочку брать</p>
<p>Ответа три</p>
</section>
<section>
<h2>Что человек хочет, а не что ему надо</h2>
<p>Прежде чем идти по инструментам, надо понять, зачем упаковка вообще нужна</p>
<p>Люди прекрасно знают, что им надо</p>
<p>Заняться зубами</p>
<p>Вставать пораньше</p>
<p>Перестать жрать всякое говно</p>
<p>Наладить отношения с семьёй</p>
<p>Больше зарабатывать</p>
<p>Это никакой не секрет, это знает каждый</p>
<p>И когда эксперт приходит и говорит ровно это, единственное желание человека - послать его подальше</p>
<p>Представьте, что друг подходит к вам и говорит: а ты не думал, что тебе надо больше денег зарабатывать?</p>
<p>Что вы сделаете</p>
<p>Отвернётесь и уйдёте</p>
<p>Есть вещи, которые человек хочет, и заходить надо через них</p>
<p>Упаковка - это и есть перевод вашего «надо» на язык его «хочу»</p>
</section>
<section>
<h2>Инструмент 1: поток спроса</h2>
<p>Поток спроса - это то, что уже сработало</p>
<p>Не то, что вам кажется интересным, а то, что люди уже посмотрели</p>
<p>Роль на разбор: фитнес-тренер</p>
<p>Смысл: не нужно убивать себя в зале, чтобы похудеть</p>
<p class="punch">Механика простая</p>
<p>Идёте на ютуб</p>
<p>Вбиваете запросы вокруг своего смысла</p>
<p>Ставите фильтр на shorts</p>
<p>Сортируете по просмотрам</p>
<p>Смотрите, какие заходы собрали аудиторию</p>
<p>Здесь важное</p>
<p>В лоб почти никогда не работает</p>
<p>Мы вбили «убился в зале» и «смерть в зале» - живого нет ничего</p>
<p>Зашли сбоку, через последствия: «температура после тренировки», «сильная усталость»</p>
<p>И там сразу 141 тысяча и 69 тысяч просмотров</p>
<p>А рядом живой заголовок - «как лучше всего восстанавливаться после тренировки»</p>
<p>Вот он и есть ваша упаковка</p>
</section>
<section>
<h2>Как из этого собирается сценарий</h2>
<p>Схема одна и та же</p>
<p>Заголовок берёте у сработавшего ролика - первые три секунды</p>
<p>Дальше свой текст и своя история, через собственный опыт</p>
<p>Дальше пруф: свой пример или пример клиента</p>
<p>В конце call to action</p>
<p>Формат при этом не важен вообще</p>
<p>Короткие, длинные - без разницы, схема не меняется</p>
</section>
<section>
<h2>Где здесь ломаются эксперты</h2>
<p>Две вещи вылезают почти у каждого, и на фитнесе это видно лучше всего</p>
<p class="punch">Первое: не могу нести то, что против моей философии</p>
<p>Дословно от тренера: «Сань, ну, типа я не могу эту хуйню нести»</p>
<p>Это нормально и это правильно</p>
<p>Упаковка чужая, смысл ваш</p>
<p>Если приходится врать - вы взяли не ту упаковку, а не «не тот инструмент»</p>
<p class="punch">Второе: red line на разбор коллег</p>
<p>Многие не готовы трогать чужие методики даже нейтрально</p>
<p>Тоже нормально, просто вычеркните этот угол и идите к следующему</p>
</section>
<section>
<h2>«Как» против «можно ли»</h2>
<p>Отдельно про формулировку заголовка, потому что здесь ошибаются все</p>
<p>Разбирали расширение смысла: похудеть без тренировок</p>
<p>Первый вариант - «как похудеть без тренировок»</p>
<p>Звучит логично, а работает плохо</p>
<p>Потому что «как» - это обучающий заголовок</p>
<p>Он говорит человеку: я тебя сейчас учить буду</p>
<p>А учиться в соцсетях никто не хочет, мы про это уже говорили</p>
<p>Второй вариант - «можно ли похудеть без тренировок»</p>
<p>Это уже любопытство, а не урок</p>
<p>Человек хочет узнать ответ, а не пройти обучение</p>
<p>И третий, самый сильный - прожитый опыт</p>
<p class="punch">«Как мы похудели без тренировок за 90 дней»</p>
<p>Здесь не обучение, а история, которая уже случилась</p>
<p>Для сравнения разобрали ролик с заголовком «три способа похудеть без тренировок» - он не сработал</p>
<p>Причина ровно та же: нет прожитого опыта, снова обучение</p>
</section>
<section>
<h2>Инструмент 2: упаковка через нейронку</h2>
<p>Роль на разбор: психолог</p>
<p>Смысл: тебе не нужно ходить к психологу, чтобы победить тревогу</p>
<p>Открываете любую нейронку - ChatGPT, Claude, Gemini, без разницы</p>
<p>Даёте ей свой смысл и просите принести к нему оболочки</p>
<p>Список, который я прошу всегда:</p>
<ul>
<li>инфоповоды</li>
<li>необычные факты из разных сфер</li>
<li>метафоры</li>
<li>практики в других странах и в другое время</li>
<li>необычные исследования</li>
<li>что-то из мира животных</li>
<li>интересные истории людей</li>
<li>что-то про звёзд и известных личностей</li>
<li>из фильмов, сериалов, игр</li>
</ul>
<p>Дальше выбираете то, что цепляет вас, и проверяете на прочность</p>
</section>
<section>
<h2>Плюс и минус этого способа</h2>
<p>Плюс очевидный: это то, что люди схавают</p>
<p>Минус менее очевидный, но важный: вас самого в таком контенте очень мало</p>
<p>Есть ребята, у которых ролики про фильмы и инфоповоды набирают 50 и 100 тысяч просмотров</p>
<p>А когда они говорят про себя - там десять лайков</p>
<p>Потому что на них смотрят как на энциклопедию, а не как на человека</p>
<p>Поэтому этот инструмент - не единственный, а один из трёх</p>
</section>
<section>
<h2>Что нашлось на живом примере</h2>
<p>Из выдачи мы выбрали скамейку дружбы в Зимбабве</p>
<p>Психиатр Диксон Чибанда: в стране на десять миллионов человек было около пяти психиатров</p>
<p>В 2006 году он обучил четырнадцать пожилых общинных медработниц базовым техникам и посадил их на деревянные скамейки</p>
<p>Точка невозврата у него была за год до этого</p>
<p>Пациентка по имени Эрика не доехала на приём, потому что не было денег на автобус</p>
<p>То есть барьер оказался не в мотивации и не в стигме, а в цене билета</p>
<p>Отдельная деталь: западная терминология там не работала вообще</p>
<p>Метод заработал, когда депрессию назвали «куфунгисиса» - слишком много думать</p>
<p>К двадцатым обучено больше семисот бабушек</p>
<p>История настоящая, история сильная, интрига есть</p>
<p>Но это ещё не заход</p>
</section>
<section>
<h2>Заголовки нейронка не умеет</h2>
<p>Это надо запомнить отдельно</p>
<p>Заголовки, которые нейронка предлагает сама, чаще всего говно</p>
<p>Её вариант к этой истории был такой: «в стране, где на шестнадцать миллионов человек четырнадцать психиатров, депрессию лечат бабушки на деревянной лавке»</p>
<p>Слишком сложно, слишком длинно, человек не дослушает</p>
<p>Заходы мы собирали руками:</p>
<ul>
<li>«Ваша бабушка может помочь вам лучше психолога»</li>
<li>«Я знаю, как трудоустроить наших бабушек»</li>
<li>«Моя бабушка получает вот столько денег, объясните, как на это прожить»</li>
</ul>
<p>А самый рабочий вариант пришёл через образ</p>
<p>Бабушки, которые сидят на лавочке возле дома</p>
<p>Мы думаем, что они там всех обсуждают, а на самом деле это психологи</p>
<p class="punch">Когда мы говорим «бабушки на лавочке» - у нас сразу картинка в голове</p>
<p>Вот отсюда правило</p>
<p>Если человек может мгновенно представить картинку - это всегда работает супер</p>
<p>И добили экспериментом: «бабушки на лавочке лучшие психологи, и я решил это проверить»</p>
<p>Дальше реально подойти к трём-пяти бабушкам и поговорить</p>
<p>Итог по инструменту: один смысл, одна упаковка, три разных ролика</p>
</section>
<section>
<h2>Инструмент 3: упаковка через сегмент</h2>
<p>Роль на разбор: коуч по отношениям</p>
<p>Смысл: полюбите себя</p>
<p>Логика тут другая</p>
<p>Когда вы целитесь в сегмент, человек узнаёт себя</p>
<p>А когда узнаёт - обращает внимание</p>
<p>Первый вопрос всегда простой: мужчины или женщины</p>
<p>А вот дальше классическая маркетинговая сегментация по возрасту не годится</p>
<p>Критерии другие:</p>
<ul>
<li>интересы</li>
<li>хобби</li>
<li>жизненный статус</li>
<li>геолокация</li>
<li>профессия</li>
<li>с чем человек себя ассоциирует</li>
<li>желание</li>
<li>боль</li>
<li>возражение</li>
<li>страх</li>
<li>психотип или характеристика</li>
</ul>
</section>
<section>
<h2>Как это звучит</h2>
<p>Два захода на том же смысле:</p>
<p class="punch">«Женщины, которые тренируются в спортзале и следят за своей фигурой, в два раза лучше чувствуют себя в отношениях»</p>
<p class="punch">«У разведёнки с прицепом сильно больше шансов найти себе хорошего мужика, нежели чем у карьеристки»</p>
<p>Цифры тут я не проверял, важен принцип</p>
<p>Во втором заходе сразу два сегмента - и карьеристка, и разведёнка</p>
<p>И да, в комментариях будет спор</p>
<p>Это не баг, это фича</p>
<p>Работает это и в лоб, на любом хобби</p>
<p>Если человек играет в баскетбол и выступает в барах с гитарой, то ролик с фразой «если вы играете в баскетбол, то, скорее всего, вы очень хорошо владеете музыкальным инструментом» он досмотрит до конца</p>
<p>Просто потому что это про него</p>
</section>
<section>
<h2>Куда девается смысл</h2>
<p>Главный вопрос по этому инструменту: а где здесь то, что я хотел сказать</p>
<p>Смысл никуда не девается, он вшивается внутрь ролика</p>
<p>Женщина ходит в зал, потому что любит себя</p>
<p>Поэтому ей хорошо в отношениях</p>
<p>Она не делегирует это другому человеку</p>
<p>Разведёнка развелась, потому что выбрала себя</p>
<p>Вот вам «полюбите себя», только его никто не проповедует</p>
<p>Сегмент - это дверь, смысл - это то, что за дверью</p>
</section>
<section>
<h2>Про вероятность</h2>
<p>Залетит ли каждый ролик, собранный по этим схемам</p>
<p>Нет</p>
<p>Но шансы это повышает сильно больше, чем работа вхолостую и наугад</p>
<p class="punch">Это казино обыгрывает тот, кто продолжает в нём играть</p>
</section>
<section>
<h2>Что делать руками</h2>
<p>Возьмите один свой смысл</p>
<p>Один, не пять</p>
<p>И прогоните его через все три инструмента подряд:</p>
<ul>
<li><strong>поток спроса</strong> - найдите на ютубе три сработавших захода вокруг темы, зайдите сбоку, если в лоб пусто</li>
<li><strong>нейронка</strong> - соберите оболочки по списку выше, выберите одну, заголовки напишите сами</li>
<li><strong>сегмент</strong> - выберите сегмент не по возрасту, а по тому, с чем человек себя ассоциирует</li>
</ul>
<p>На выходе у вас три разных ролика с одним и тем же смыслом</p>
<p>Идите, работайте, практикуйтесь</p>
</section>
</main>
