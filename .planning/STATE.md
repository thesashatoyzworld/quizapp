...
**Current focus:** Landing page conversion optimization (Phases 12.1-12.3)
...
**v3.0 Коннекторы Upsell Funnel:** 🚧 In Progress (Phases 11-15)
...
- Phase 12.1-12.3: Прозрачность оффера > пулепробиваемость (не раздувать обещания)
...
- State lost on page refresh (from UX audit — CRITICAL)
