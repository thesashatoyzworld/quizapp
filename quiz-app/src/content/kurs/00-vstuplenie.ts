// Статья урока «00-vstuplenie» курса «Новый Уровень Контента».
// СГЕНЕРИРОВАНО: GSD-BRAND/scripts/kurs-to-ts.mjs 00 — руками не править,
// править исходник kurs/00-vstuplenie.html и перегенерировать.

export const VSTUPLENIE_00 = `<!doctype html>
<html lang="ru">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Шесть уровней навыка · Новый уровень контента</title>
<style>
/* ============================================================
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Начало</div>
  <h1>Шесть уровней навыка</h1>
  <p class="dek">Контент — это навык, а не лотерея. Здесь карта из шести уровней и правило, с какого начинать.</p>
  <div class="taskline"><b>Задача:</b> Найдите свой уровень и двигайтесь с него, а не с того, на котором хотели бы быть.</div>
</div></header>
...
<main class="wrap">
<section>
<p>Итак, добро пожаловать</p>
<p>Если вы это читаете или смотрите - вы затрахались искать ответы на свои вопросы по тому, как делать контент с кайфом и чтоб он работал</p>
<p>Если вы не читали мою бесплатную статью о том, как я подхожу к работе с контентом - вам сюда (тут повторяться не буду): <a href="https://thesashatoyz.com/blog/urovni-navyka-kontenta" target="_blank" rel="noopener">https://thesashatoyz.com/blog/urovni-navyka-kontenta</a></p>
</section>
<section>
<h2>Контент — это навык</h2>
<p>Я воспринимаю работу с контентом, как с навыком</p>
<p>В моем понимании это единственный выгодный подход и ракурс для работы с контентом</p>
<p>Потому что тогда любые ваши действия - имеют накопительный эффект</p>
<p>И вот в чем главная беда, когда результатом становятся цифры</p>
<p>Мы становимся зависимыми от них</p>
<p>Проверяем телефон как психи: сколько лайков, сколько просмотров, сколько подписок</p>
<p>И настроение на весь день зависит от того, что там</p>
<img src="/kurs/assets/rab-cifr.png" alt="">
<p>Я не хочу быть рабом цифр и не хочу, чтобы ими становились вы</p>
<p>То есть мы здесь не может проиграть априоре</p>
<p>И я могу вам это доказать</p>
</section>
<section>
<h2>Количество бьёт подготовку</h2>
<p>Эксперимент «зефирная башня»:</p>
<div class="kcar" data-i="0" data-n="5">
      <div class="kcfrs"><figure class="kcfr on"><img src="/kurs/assets/marshmallow-1.png" alt="">
         <figcaption><b>условия у всех одинаковые</b><span>двадцать спагетти, метр скотча, метр верёвки и одна зефирка. восемнадцать минут. башня должна стоять сама, зефирка сверху</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/marshmallow-2.png" alt="">
         <figcaption><b>две команды</b><span>слева дети из детского сада. справа выпускники бизнес-школ: те, кого учили планировать, оценивать риски и распределять роли</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/marshmallow-3.png" alt="">
         <figcaption><b>первая башня падает у всех</b><span>зефирка всегда оказывается тяжелее, чем кажется на бумаге. разница не в том, что она упала. разница в том, что происходит дальше</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/marshmallow-4.png" alt="">
         <figcaption><b>дети пробуют, взрослые проектируют</b><span>дети ставят зефирку сразу и смотрят, что будет. упало, значит уже понятно, где слабое место. взрослые возвращаются к схеме и ищут конструкцию, которая точно устоит</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/marshmallow-5.png" alt="">
         <figcaption><b>у детей башня выше</b><span>не потому что они умнее. потому что их вариант проверен семь раз, а идеально спроектированный только один, и проверять его было уже некогда</span></figcaption></figure></div>
      <div class="kcbar"><button class="kcarrow" data-d="-1">‹</button><div class="kcdots"><button class="kcdot on" data-i="0"></button><button class="kcdot" data-i="1"></button><button class="kcdot" data-i="2"></button><button class="kcdot" data-i="3"></button><button class="kcdot" data-i="4"></button></div>
        <button class="kcarrow" data-d="1">›</button><span class="kccnt">1 / 5</span></div>
    </div>
<p class="punch">Количество попыток и играючий подход выигрывают у идеального плана и проектирования</p>
<p>И дело не в возрасте. Тот же принцип проверяли на студентах-фотографах:</p>
<div class="kcar" data-i="0" data-n="4">
      <div class="kcfrs"><figure class="kcfr on"><img src="/kurs/assets/fotografy-1.png" alt="">
         <figcaption><b>набор у всех одинаковый</b><span>камера, плёнка, бумага, кювета для проявки. и полгода времени</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/fotografy-2.png" alt="">
         <figcaption><b>класс делят пополам</b><span>одной половине раздают камеры. вторая садится готовиться</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/fotografy-3.png" alt="">
         <figcaption><b>а вот условия разные</b><span>первую группу оценивают по количеству снятых кадров. вторую по качеству одного-единственного снимка, к которому она готовится все шесть месяцев</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/fotografy-4.png" alt="">
         <figcaption><b>лучшие фотографии оказались у первой группы</b><span>у тех, кто просто снимал. полгода они ошибались, смотрели на результат и снимали снова. вторая группа за то же время получила одну аккуратную фотографию и стопку теории</span></figcaption></figure></div>
...
<p class="punch">Качество появляется из количества, а не из подготовки к нему</p>
<p>В начале - всегда сложно</p>
<p>Потому что это новое и незнакомое</p>
<p>Но с практикой и временем любые действия начинают даваться проще и забирать меньше ресурса</p>
<p>Попытки выбить "джекпот" и сократить маршрут, лишь удлиняют его</p>
<p>И теперь про то, как это выглядит изнутри</p>
</section>
<section>
<h2>Туман войны</h2>
<p>Если вы играли хоть в одну игру с картой - вы знаете, что такое туман войны</p>
<p>Вся карта закрыта, вы видите только то, что вокруг вас</p>
<div class="kcar" data-i="0" data-n="6">
      <div class="kcfrs"><figure class="kcfr on"><img src="/kurs/assets/tuman-1.png" alt="">
         <figcaption><b>в начале открыт только пятачок под ногами</b><span>вы не знаете ни куда идти, ни что там дальше. и это нормально, так начинают все</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/tuman-2.png" alt="">
         <figcaption><b>отсюда невозможно проложить маршрут до цели</b><span>вы её просто не видите. а если построите план вслепую, упрётесь в то, чего на вашей карте не было</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/tuman-3.png" alt="">
         <figcaption><b>карта открывается, когда вы делаете шаг</b><span>не раньше. не после того, как вы всё продумали, а после того, как сдвинулись</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/tuman-4.png" alt="">
         <figcaption><b>и вот теперь появился выбор</b><span>через обрыв не пройти, через мост можно. со старта этого выбора для вас не существовало</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/tuman-5.png" alt="">
         <figcaption><b>каждый следующий шаг открывает ещё кусок</b><span>вы всё ещё не видите всю карту. но видите достаточно, чтобы сделать следующий шаг</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/tuman-6.png" alt="">
         <figcaption><b>дошли</b><span>и только отсюда видно, что маршрут оказался вообще не таким, каким вы его представляли в начале</span></figcaption></figure></div>
...
<p class="punch">Маршрут нельзя построить заранее. Его можно только пройти</p>
<p>Именно поэтому я не даю вам одну схему на всех</p>
<p>Я не знаю вашу карту, вы её тоже пока не знаете</p>
<p>Зато я знаю, как она открывается</p>
</section>
<section>
<h2>Опыт и артефакты</h2>
<p>И вторая вещь из игр, которая здесь работает точно так же:</p>
<div class="kcar" data-i="0" data-n="6">
      <div class="kcfrs"><figure class="kcfr on"><img src="/kurs/assets/igra-uroven-1.png" alt="">
         <figcaption><b>новый мир, пути вперёд закрыты</b><span>вам доступен первый уровень. на второй нужен опыт, на третий артефакт. опыта ноль</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/igra-uroven-2.png" alt="">
         <figcaption><b>проходите первый уровень, получаете опыт</b><span>не за победу над драконом. за то, что вышли и сделали</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/igra-uroven-3.png" alt="">
         <figcaption><b>ещё опыт</b><span>каждое действие капает в шкалу. даже то, которое вам показалось неудачным</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/igra-uroven-4.png" alt="">
         <figcaption><b>но часть путей всё ещё закрыта</b><span>и это не наказание. просто вы туда пока не дотягиваетесь, и попытка залезть раньше времени закончится тем, что вас оттуда стащит</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/igra-uroven-5.png" alt="">
         <figcaption><b>на первом уровне лежит артефакт</b><span>его нельзя купить и нельзя получить на бегу. только пройдя этот уровень</span></figcaption></figure><figure class="kcfr"><img src="/kurs/assets/igra-uroven-6.png" alt="">
         <figcaption><b>шкала заполнилась, новые уровни открылись сами</b><span>вы их не выбивали. вы просто закрыли то, что было под ногами</span></figcaption></figure></div>
      <div class="kcbar"><button class="kcarrow" data-d="-1">‹</button><div class="kcdots"><button class="kcdot on" data-i="0"></button><button class="kcdot" data-i="1"></button><button class="kcdot" data-i="2"></button><button class="kcdot" data-i="3"></button><button class="kcdot" data-i="4"></button><button class="kcdot" data-i="5"></button></div>
        <button class="kcarrow" data-d="1">›</button><span class="kccnt">1 / 6</span></div>
    </div>
<p class="punch">Уровень нельзя перепрыгнуть. Его можно только закрыть</p>
</section>
<section>
<h2>Найдите свой уровень</h2>
<p>Поэтому для начала вам важно определить - на каком вы уровне и начать именно с него:</p>
<img src="/kurs/assets/10-1.png" alt="">
<p>Прелесть этой системы в том, что не надо проходить тесты</p>
<p>Просто прочитайте шесть строк и найдите себя:</p>
<div class="ix" data-ix="diag"></div>
<ul><li><strong>Уровень 1</strong> - хотите, но ничего не делаете</li><li><strong>Уровень 2</strong> - когда-то делали, но бросили</li><li><strong>Уровень 3</strong> - делаете, но вас раздражает то, что вы делаете</li><li><strong>Уровень 4</strong> - не раздражает, но времени не хватает</li><li><strong>Уровень 5</strong> - времени хватает, а отклика нет</li><li><strong>Уровень 6</strong> - все работает, хочу больше</li></ul>
<p>Если вам кажется, что вы между двумя - берите тот, что ниже</p>
<p>Это не про то, чтобы себя занизить</p>
<p>Это про то, чтобы не тащить наверх нерешенную задачу, которая потом вас оттуда стащит</p>
<p>И дальше самое важное</p>
<p class="punch">Двигайтесь с того уровня, на котором вы сейчас, а не с того, на котором хотели бы быть</p>
<p>Не надо читать все подряд и пытаться внедрять все сразу</p>
<p>Каждый уровень решает свою задачу, и пока не решена предыдущая, следующая просто не сработает</p>
<p>И мы пойдем по каждому из них</p>
</section>
<section>
<h2>Как этим пользоваться</h2>
<p>Каждый уровень устроен одинаково:</p>
<ul><li>разбор, что с вами происходит и почему</li><li>инструменты, которыми это чинится</li><li><strong>задача</strong> - то, что вы делаете руками</li><li><strong>маркер</strong> - по нему вы поймете, что уровень закрыт и можно идти дальше</li></ul>
<p>Задача важнее, чем прочитать следующий уровень</p>
<p>Читать приятно, делать - нет, поэтому мозг будет предлагать вам читать дальше вместо того, чтобы закрывать текущий</p>
<p>Не ведитесь</p>
<h3>Сверка раз в месяц</h3>
<p>Это единственный ритуал, о котором я вас прошу</p>
<p>Раз в месяц открываете карту уровней и отвечаете на три вопроса:</p>
<ul><li>1. <strong>На каком уровне я сейчас</strong> - честно, по маркерам, а не по тому, где хотелось бы быть</li><li>2. <strong>Что изменилось за месяц</strong> - что стало легче, что перестало бесить, что появилось нового</li><li>3. <strong>Меня не откатило</strong> - и если откатило, то на чем</li></ul>
<p>Пятнадцать минут</p>
<p>Без этого через два месяца вы не сможете отличить движение от топтания, а это самая частая причина бросить</p>
<h3>Если вас откатило</h3>
<p>Откат - это нормально и это будет</p>
<p>Заболели, ушли в проект, уехали, выгорели - и контент осыпался</p>
<p>И вот тут включается сравнение с теми, у кого «все ровно»</p>
<p>У них не ровно</p>
<p>Вы видите кусок их пути через маленькое окно, а остальное дорисовываете сами</p>
<p>Ровную линию вверх вам показали не потому, что она была ровной, а потому что ям вам никто не показывает</p>
<p>Про свои ямы вы знаете все, про чужие - ничего</p>
<p>Один и тот же путь на разном увеличении выглядит по-разному: вблизи видно только качели, а если сделать зум-аут на годы, тот же кусок почти не заметен</p>
<p class="punch">Откат видно вблизи. На дистанции вы все равно идете вверх</p>
<p>Это не значит, что надо забить и ждать</p>
<p>Это значит, что откат - не повод считать, что все было зря</p>
<p>Правило простое: <strong>возвращаетесь на тот уровень, где сломалось, и работаете с ним</strong></p>
<p>Не начинаете сначала и не продолжаете с того места, где остановились</p>
<p>Если контент снова стал бесить - вам на третий, даже если до этого вы были на пятом</p>
<p>Прошлый прогресс никуда не делся, вам не надо проходить все заново</p>
<p>Вы просто чините то, что сломалось</p>
<p>Очки накоплены, они никуда не делись - не обесценивайте свой предыдущий опыт</p>
</section>
<section>
<h2>Про техническую часть</h2>
<p>В этом курсе мы разбираем смысловую сторону: что делать, почему это не идет и как выстроить процесс под себя</p>
<p>Всё это происходит у вас в голове: от того, как вы смотрите на эту работу и как воспринимаете результаты, складываются дальнейшие действия. До действий мы дойдем, но сначала важно разобраться с тем, как вы это все воспринимаете</p>
<p>Если вы хотите разбираться в технических составляющих - хуки, заголовки, призывы к действию, как читать аналитику, как подбирать форматы, что люди сохраняют и почему пересылают - все это подробно разобрано в <strong>Формуле Вирусного Контента</strong>, доступ к которой у вас есть</p>
</section>
<section>
<h2>Погнали по уровням</h2>
<p>Я определил шесть уровней этого навыка</p>
<img src="/kurs/assets/karta-urovney-crop.png" alt="">
<p>Вот эта лестница, кто не видел - смотрите еще раз</p>
