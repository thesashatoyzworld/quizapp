...
(function () {
  ...
  {
    key: "sposoby",
    title: "Где искать заходы",
    note: "Инстаграм коллег, ютуб, английский сегмент, смежные ниши и нейронка. Что делать, когда своя лента уже вычерпана.",
    html: `<!doctype html>
<html lang="ru">
<head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="robots" content="noindex">
<title>Где искать заходы · Поток Спроса</title>
<style>
/* ============================================================
   НОВЫЙ УРОВЕНЬ КОНТЕНТА — статьи уровней.
   Системный стиль, как в algoritm-sistema.html: Times, колонка 620,
...
<header class="arthead"><div class="ahin">
  <div class="lvlbadge">Поток Спроса</div>
  <h1>Где искать заходы</h1>
  <p class="dek">Инстаграм коллег, ютуб, английский сегмент, смежные ниши и нейронка. Что делать, когда своя лента уже вычерпана.</p>
</div></header>
